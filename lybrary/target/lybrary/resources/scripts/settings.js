$(document).ready(function(){
	...
	$("#new_user_save").click(function(){
		$.post("/newUser", {name:$("#settings_name").val(), surname:$("#settings_surname").val(), currentPassword:$("#settings_current_password").val(), newPassword:$("#settings_new_password").val(), adress:$("#settings_adress").val(), phone:$("#settings_phone").val()}, function(result){
			alert(result)
		});
	});
